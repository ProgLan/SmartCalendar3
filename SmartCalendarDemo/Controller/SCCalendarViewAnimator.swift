...
public final class SCCalendarViewAnimator {
    private unowned let calendarView: CalendarView
    
    // MARK: - Public properties
    public var delegate: SCCalendarViewAnimatorDelegate!
    public var coordinator: SCCalendarDayViewControlCoordinator {
        get {
...
extension SCCalendarViewAnimator {
...
extension SCCalendarViewAnimator: SCCalendarViewAnimatorDelegate {
...
private extension SCCalendarViewAnimator {
