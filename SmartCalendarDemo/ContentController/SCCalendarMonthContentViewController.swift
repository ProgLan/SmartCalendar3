//
//  SCCalendarMonthContentViewController.swift
//  SmartCalendar
//
...
public final class SCCalendarMonthContentViewController: SCCalendarContentViewController {
    ...
    public func initialLoad(date: NSDate) {
        ...
        calendarView.presentedDate = SCDate(date: presentedMonthView.date)
    }
...
extension SCCalendarMonthContentViewController {
...
extension SCCalendarMonthContentViewController {
    ...
    public func selectDayViewWithDay(day: Int, inMonthView monthView: SCCalendarMonthView) {
        let coordinator = calendarView.coordinator
        monthView.mapDayViews { dayView in
