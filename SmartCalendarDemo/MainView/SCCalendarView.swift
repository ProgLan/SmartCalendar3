...
public typealias Weekday = SCCalendarWeekday
public typealias Animator = SCCalendarViewAnimator
...
public typealias MenuViewDelegate = SCCalendarMenuViewDelegate
public typealias TouchController = SCCalendarTouchController
public typealias SelectionType = SCSelectionType

public final class SCCalendarView: UIView {
    ...
    public var delegate: SCCalendarViewDelegate? {
        didSet {
            if manager == nil {
...
extension SCCalendarView {
    public func didSelectDayView(dayView: SCCalendarDayView) {
...
private extension SCCalendarView {
